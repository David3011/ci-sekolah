<div class="container-fluid mt-4">
	...
	<div class="card mt-2">
		...
		<div class="card-body">
			...
			<form action="<?= site_url("mapel/edit") ?>" method="post">
				<div class="form-group">
					<label for="id_mapel">ID Mapel</label>
					<input type="text" class="form-control" id="id_mapel" name="id_mapel" value="<?= $row->id_mapel ?>" readonly>
				</div>
				<div class="form-group">
					<label for="nama">Nama</label>
					<input type="text" class="form-control" id="nama" name="nama" value="<?= $row->nama_mapel ?>">
				</div>
